...
int main() {
	...
	Menu menu = Menu("Console Menu","Press NUMPAD0 to exit");
	menu.AddOption("[N1] OFF-ON", 0); //Option with Status = false
	menu.AddOption("[N2] Download",0); //Option with Status = false
